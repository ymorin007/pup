Pup::Application.routes.draw do
  ...
  match 'animals' => 'guests#animals', :as => :animals
  match 'services' => 'guests#services', :as => :services
  match 'accessories' => 'guests#accessories', :as => :accessories
